      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <Link href="/privacy" className="text-sm text-slate-600 hover:text-gray-600">Privacy</Link>
            <Link href="/terms" className="text-sm text-slate-600 hover:text-gray-600">Terms</Link>
            <Link href="/cookies" className="text-sm text-slate-600 hover:text-gray-600">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
